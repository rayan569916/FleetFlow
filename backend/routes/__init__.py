...
def register_routes(app):
    ...
    app.register_blueprint(auth_mobile_bp, url_prefix='/api/mobile/auth_mobile')
    app.register_blueprint(cargo_mobile_bp, url_prefix='/api/mobile/requests')
    ...
    app.register_blueprint(customer_support_details_bp, url_prefix='/api/mobile/customer_support_details')
